...
- **[TASK-001] 🔴 MUST** — для feature/bugfix определяется пользовательский или административный сценарий; для architecture/chore/docs определяется техническая цель, мотивация и проверяемый результат;
