...
Текущий репозиторий находится на стадии инженерного фундамента: исполняемого
приложения, API и БД пока нет, но базовый CI уже существует. M1 описан в
[`docs/architecture/m1-shell.md`](./m1-shell.md) и реализуется через VPZH-010.
